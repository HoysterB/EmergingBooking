...
internal class Room
{
    ...
    public Room(string name, string description, int capacity, int availableQuantity, decimal pricePerNight,
        Guid? code = null)
    {
        Name = name;
    ...
    public void AddAmenities(string amenity)
    {
        ...
        {
            throw new InvalidOperationException($"The amenity {amenity} was alredy added");
        }
